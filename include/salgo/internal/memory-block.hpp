	...
	namespace internal {
		namespace memory_block {
			...
			template<class _VAL, class _ALLOCATOR, int _STACK_BUFFER, bool _DENSE,
					bool _CONSTRUCTED_FLAGS_INPLACE, bool _CONSTRUCTED_FLAGS_BITSET, bool _COUNT, int _ALIGN>
			struct Context {
				...
				struct alignas(Align) Node : salgo::Inplace_Storage<Val>, Add_exists<Exists_Inplace> {};
				...
				struct With_Builder : Memory_Block {
					...
					using ALLOCATOR =
					typename Context< Val, NEW_ALLOCATOR, Stack_Buffer, Dense, Exists_Inplace, Exists_Bitset, Count, Align > :: With_Builder;

					template<int NEW_STACK_BUFFER>
					using INPLACE_BUFFER =
					typename Context< Val, Allocator, NEW_STACK_BUFFER, Dense, Exists_Inplace, Exists_Bitset, Count, Align > :: With_Builder;


					using DENSE =
					typename Context< Val, Allocator, Stack_Buffer, true, Exists_Inplace, Exists_Bitset, Count, Align > :: With_Builder;

					using SPARSE = // (default)
					typename Context< Val, Allocator, Stack_Buffer, false, Exists_Inplace, Exists_Bitset, Count, Align > :: With_Builder;


					using CONSTRUCTED_FLAGS_INPLACE =
					typename Context< Val, Allocator, Stack_Buffer, Dense, true, false, Count, Align > :: With_Builder;

					using CONSTRUCTED_FLAGS_BITSET =
					typename Context< Val, Allocator, Stack_Buffer, Dense, false, true, Count, Align > :: With_Builder;
					...
					using COUNT =
					typename Context< Val, Allocator, Stack_Buffer, Dense, Exists_Inplace, Exists_Bitset, true, Align > :: With_Builder;

					template<int X>
					using ALIGN =
					typename Context< Val, Allocator, Stack_Buffer, Dense, Exists_Inplace, Exists_Bitset, Count, X > :: With_Builder;

					using FULL_BLOWN =
					typename Context< Val, Allocator, Stack_Buffer, Dense, false, true, true, Align > :: With_Builder; // by default bitset-exists
				};
