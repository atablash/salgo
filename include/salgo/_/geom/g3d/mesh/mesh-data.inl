...
SALGO_ADD_MEMBER(subvert);
SALGO_ADD_MEMBER(subvert_link);
SALGO_ADD_MEMBER(link);
SALGO_ADD_MEMBER(poly_links);
SALGO_ADD_MEMBER(edges);
...
template<class P>
struct H_VertPoly : Pair_Handle_Base<H_VertPoly<P>, typename P::H_Vert, typename P::Vert_Poly_Links::Handle> {
	using BASE = Pair_Handle_Base<H_VertPoly<P>, typename P::H_Vert, typename P::Vert_Poly_Links::Handle>;
	using BASE::BASE;
};
